...
//Künstler
$test = $db->query("INSERT INTO `kuenstler` (`pk_kuenstler`, `name`, `beschreibung`, `bild`) VALUES (
    NULL, 
    'Milky Chance', 
...
//Album
$db->query("INSERT INTO `album` (`pk_album`, `name`, `bild`, `fk_kuenstler`) VALUES (NULL, 'Sadnecessary', 'milkychance.gif', '1')");
$db->query("INSERT INTO `album` (`pk_album`, `name`, `bild`, `fk_kuenstler`) VALUES (NULL, 'Wrong Crowd', 'tomodell.gif', '2')");
$db->query("INSERT INTO `album` (`pk_album`, `name`, `bild`, `fk_kuenstler`) VALUES (NULL, 'Blue & Lonesome', 'rollingstones.gif', '3')");
